...
int main(){
    ...
    fflush(stdout);
    iniciaAlocador();
    a[0] = alocaMemC("Aloca 50\n", 50, TopoInicialHeap);
    a[1] = alocaMemC("Aloca 10\n", 10, a[0]+50);
    a[2] = alocaMemC("Aloca 60\n", 60, a[1]+10);
    a[3] = alocaMemC("Aloca 10\n", 10, a[2]+60);
    a[4] = alocaMemC("Aloca 86\n", 86, a[3]+10);

    liberaMemC("Libera nodo 0\n", a[0], 1);
    liberaMemC("Libera nodo 2\n", a[2], 1);
    liberaMemC("Libera nodo 4\n", a[4], 1);
    a[0] = alocaMemC("Aloca 5\n", 5, 0);
    a[2] = alocaMemC("Aloca 10\n", 10, 0);
    a[4] = alocaMemC("Aloca 15\n", 15, 0);
